...
public class Benchmark1 extends Benchmark {
    ...
    @Option(name = "-l", aliases = "--loop", usage = "a number of measurement")
    private int loop = 5;

    @Option(name = "-e", aliases = "--entries", usage = "an entries putting the container")
    private int entries = 30000;

    @Option(name = "-s", aliases = "--size", usage = "a size of entry")
    private int entrySize = 30000;
    ...
    public static void main(String[] args) throws CmdLineException, IOException {
        ...
        switch (b.target) {
        case 1:
            task = new FileStoredMapBench(b.entries, b.entrySize);
            break;
        case 2:
            task = new BerkeleyDbBench(b.entries, b.entrySize);
            break;
        default:
            parser.printUsage(System.err);
            return;
